...
In this section we will see how kernels enable SVMs to model complex non-linear data. Suppose we have a dataset like that in <a href="#ellipserandom">Figure 17</a>. 
...
<figure id="ellipserandom">
    ...
    <figcaption>Figure 17. Non linear data scattered on its features space $(x_1, x_2)$. In this plots coordinates are randomly generated to fill two ellipses.</figcaption>
</figure>
...
Let's manually choose three points in the feature space $(x_1, x_2)$, that we will call the **landmarks** $l^{(1)}, l^{(2)}, l^{(3)}$ (<a href="#manuallandmarks">Figure 18</a>). We are going to define our as a measure of similarity between the training examples and the landmarks.
...
<figure id="manuallandmarks">
    ...
    <figcaption>Figure 18. Three landmarks points chosen manually</figcaption>
</figure>
...
By looking at <a href="#gaussk">Figure 19</a>, we can see how $f_1 \to 1$ when $x_1 \to 3$ and $x_2 \to 5$, where $(3, 5)$ are the coordinates of $l^{(1)}$. 
...
<figure id="gaussk">
    ...
    <figcaption>Figure 19. Three-dimensional surface and contour plot of the value the gaussian kernel $f_1$ as a function of the features $x_1$ and $x_2$. The three couple of plots are views of the kernel values when $\sigma^2= 1, 0.5, 3$ respectively.</figcaption>
</figure>
...
### Multiple landmarks
Let's get back to <a href="#manuallandmarks">Figure 18</a> and let's try to put together what we have learned in the case of multiple landmarks.
...
Now let's consider various training examples placed on the features space $(x_1, x_2)$ represented on <a href="#manuallandmarks2">Figure 20</a>.
...
<figure id="manuallandmarks2">
    ...
    <figcaption>Figure 20. Manually placed landmarks as in <a href="#manuallandmarks">Figure 18</a> and training example falling close or far from landmarks.</figcaption>
</figure>
...
* bandwidth parameter $\sigma^2$, as we can infer from <a href="#gaussk">Figure 19</a>:
