...
In this section we will see how kernels enable SVMs to model complex non-linear data. Suppose we have a dataset like that in <a href="#fig:ellipserandom">Figure 21</a>. 
...
<figure id="fig:ellipserandom">
    ...
    <figcaption>Figure 21. Non linear data scattered on its features space $(x_1, x_2)$. In this plots coordinates are randomly generated to fill two ellipses.</figcaption>
</figure>
...
Let's manually choose three points in the feature space $(x_1, x_2)$, that we will call the **landmarks** $l^{(1)}, l^{(2)}, l^{(3)}$ (<a href="#fig:manuallandmarks">Figure 22</a>). We are going to define our as a measure of similarity between the training examples and the landmarks.
...
<figure id="fig:manuallandmarks">
    ...
    <figcaption>Figure 22. Three landmarks points chosen manually</figcaption>
</figure>
...
By looking at <a href="#fig:gaussk">Figure 23</a>, we can see how $f_1 \to 1$ when $x_1 \to 3$ and $x_2 \to 5$, where $(3, 5)$ are the coordinates of $l^{(1)}$. 
...
<figure id="fig:gaussk">
    ...
    <figcaption>Figure 23. Three-dimensional surface and contour plot of the value the gaussian kernel $f_1$ as a function of the features $x_1$ and $x_2$. The three couple of plots are views of the kernel values when $\sigma^2= 1, 0.5, 3$ respectively.</figcaption>
</figure>
...
### Multiple landmarks
Let's get back to <a href="#fig:manuallandmarks">Figure 22</a> and let's try to put together what we have learned in the case of multiple landmarks.
...
Now let's consider various training examples placed on the features space $(x_1, x_2)$ represented on <a href="#fig:manuallandmarks2">Figure 24</a>.
...
<figure id="fig:manuallandmarks2">
    ...
    <figcaption>Figure 24. Manually placed landmarks as in <a href="#fig:manuallandmarks">Figure 22</a> and training example falling close or far from landmarks.</figcaption>
</figure>
